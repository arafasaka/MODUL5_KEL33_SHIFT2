...
export default class Pulsa extends Component {
    ...
    handleButtonUpdate = (id, name, saldo, harga, bonus) => {
                        ...
                        {this.state.pulsa.map((results, index) => {
                            return (
                                <div className="card bg-dark text-white" key={results._id}>                 
                                    ...
                                    <button className="button bg-warning" onClick={() => this.handleButtonUpdate(results._id, results.name, results.saldo, results.harga, results.bonus) } >                   
                                        {" "}                   
                                        Update Pulsa                 
                                    </button>
                                    <Modal
